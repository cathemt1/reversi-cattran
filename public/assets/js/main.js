...
socket.on('join_room_response', (payload) =>{
    ...
    /*If we are being notified by ourselves, ignore message and return*/
...
/*
    ...
    */
    ...
    /*announce when someone has arrived*/
...
socket.on('game_update', (payload) =>{
    ...
    for(let row = 0; row <8; row++){
        for(let column= 0; column <8; column++){
            /*Check to see if the server changed any space on board*/
            if(old_board[row][column]!== board[row][column]){
                ...
                if((old_board[row][column]!== '?') && (board[row][column] === ' ' )){
                    ...
                    graphic = "empty-white.gif";
                    altTag = "white token";
                }
                else if((old_board[row][column]!== '?') && (board[row][column] === 'b' )){
                    graphic = "empty-black.gif";
                    altTag = "black token";
                }
                else if((old_board[row][column]!== ' ') && (board[row][column] === 'w' )){
                    graphic = "empty-white.gif";
                    ...
                    graphic = "white-empty.gif";
                    altTag = "empty space";
                }
                else if((old_board[row][column]!== 'b') && (board[row][column] === ' ' )){
                    graphic = "black-empty.gif";
                    altTag = "empty space";
                }
                else if((old_board[row][column]!== 'w') && (board[row][column] === 'b' )){
                    graphic = "white-flip.gif";
                    altTag = "black token";
                }
                else if((old_board[row][column]!== 'b') && (board[row][column] === 'w' )){
                    graphic = "black-slip.gif";
                    altTag = "white token";
                }
                else {
                    graphic = "error.gif";
